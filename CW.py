...
for epoch in range(8):  # 训练8次
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        inputs= carlini_wagner_l2(net, inputs, 10, t.tensor([5]*batch_size),targeted=False).detach().cpu()
        # 梯度清零
        optimizer.zero_grad()
...
t.save(net, "cifar10_3_adv_cw.pkl")
# 保存網絡當前的狀態
t.save(net.state_dict(), "cifar10_new_3_adv_cw.pkl")
#
# correct = 0  # 预测正确图片数
# total = 0  # 总图片数
