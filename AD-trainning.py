...
def ld_cifar10():
    ...
    train_dataset = torchvision.datasets.CIFAR10(root='/tmp/data', train=True, transform=train_transforms,
                                                 download=True)
...
if __name__ == '__main__':
    ...
    flags.DEFINE_float('eps', 0.3, 'Total epsilon fo r FGM and PGD attacks.')
